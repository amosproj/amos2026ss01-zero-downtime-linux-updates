...
A systemd unit file is provided in [`bootc/orchestrator.service`](../bootc/orchestrator.service). To install it:

```bash
sudo cp bootc/orchestrator.service /etc/systemd/system/
