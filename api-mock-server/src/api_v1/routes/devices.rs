...
async fn create_device(Json(body): Json<DeviceCreate>) -> Response {
    ...
    match db::add_device(body.uuid, body.public_key, body.hostname, body.tenant_id, body.group_id).await {
...
async fn update_device(Path(id): Path<i32>, Json(body): Json<DeviceCreate>) -> Response {
    ...
    match db::update_device(id, body.uuid, body.public_key, body.hostname, body.tenant_id, body.group_id).await {
