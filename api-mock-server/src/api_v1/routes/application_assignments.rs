...
use amos_common::entities::{ApplicationAssignment, CreateApplicationAssignment};
use axum::{
    Json, Router,
    extract::{Path, Query},
    http::StatusCode,
...
async fn create_application_assignment(Json(body): Json<CreateApplicationAssignment>) -> Response {
